all: GrafoListaAr.o Grafo.o GrafoListaAdj.o Aresta.o Vertice.o Main.o GrafoMatriz.o
	g++ GrafoListaAr.o Grafo.o GrafoListaAdj.o Aresta.o Vertice.o Main.o GrafoMatriz.o -o Main.exe
...
GrafoListaAr.o: src/Grafo.h src/GrafoListaAr.h src/GrafoListaAr.cpp
	g++ -c src/GrafoListaAr.cpp
